...
/// <summary>
/// Capítulo 20 — A definir. Consulte docs/book/27-capitulo-20.md.
/// </summary>
public sealed class Chapter20 : IChapter
{
	...
	{
		await BenchmarkUtils.MeasureAsync("cap20/chain/default", async () =>
		{
			await Task.Delay(5);
			return "ok";
		});
	...
	{
		await BenchmarkUtils.MeasureAsync("cap20/graph/default", async () =>
		{
			await Task.Delay(5);
			return "ok";
		});
	...
	{
		await BenchmarkUtils.MeasureAsync("cap20/benchmark/default", async () =>
		{
			await Task.Delay(1);
			return "ok";
		});
