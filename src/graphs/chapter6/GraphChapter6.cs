namespace GraphIABook.Graphs.Chapter6;
...
/// <summary>
/// Chapter 6 — SKG graph focusing on scalability and concurrency.
/// Builds a graph with preprocess -> five independent branches (parallel) -> aggregator merge.
/// Configures concurrency to enable parallel execution and validates acyclicity.
/// </summary>
public static class GraphChapter6
{
    ...
    public static GraphExecutor CreateExecutor()
    {
        ...
        // Wire graph
        var executor = new GraphExecutor("ch6_fanout", "Parallel fan-out with aggregator");
