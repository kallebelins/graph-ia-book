namespace GraphIABook.Chains.Chapter6;

using Microsoft.SemanticKernel;

/// <summary>
/// Chapter 6 — SK chain focusing on scalability and concurrency limitations of linear pipelines.
/// Simulates a fan-out of five independent branches executed sequentially, followed by an aggregator.
/// Used to contrast against the SKG graph version that executes branches in parallel.
/// </summary>
public static class ChainChapter6
{
    ...
    /// All branches are logically independent but executed sequentially in the chain.
    /// </summary>
